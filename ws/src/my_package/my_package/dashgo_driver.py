...
class BaseController:
    def __init__(self, Stm32, base_frame,node):
        ...
        self.node.create_subscription("smoother_cmd_vel", Twist, self.cmdVelCallback)
        ...
        self.node.create_subscription("is_passed", Int16, self.isPassedCallback)
        self.isPassed = True

        self.node.create_subscription("is_passed_2", Int16, self.isPassedCallback_2)
        ...
        self.node.create_subscription("recharge_handle", Int16, self.handleRechargeCallback)
        ...
        self.node.create_subscription("imu_reset", Int16, self.resetImuCallback)
        ...
        self.node.create_subscription("ware_version_req", Int16, self.reqVersionCallback)
        ...
        self.node.create_subscription("pid_req", String, self.reqPidCallback)
        self.node.create_subscription("pid_set", String, self.reqSetPidCallback)

        self.node.create_subscription("encoder_reset", Int16, self.resetEncoderCallback)
        self.node.create_subscription("system_reset", Int16, self.resetSystemCallback)
